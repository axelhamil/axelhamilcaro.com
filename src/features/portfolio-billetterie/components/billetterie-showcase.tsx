...
export function BilletterieBackdrop() {
  return (
    <div
...
export function BilletterieHero() {
        ...
        <RevealContainer className="max-w-4xl">
          ...
          <RevealItem>
            ...
            >
              ...
              réel via WebSocket, gestion automatisée des tarifs et TVA. Projet
              sous NDA.
            </Paragraph>
          </RevealItem>
        </RevealContainer>
...
export function BilletterieStats() {
  return (
    <section
...
export function BilletterieContext() {
  return (
      ...
      <RevealContainer className="container mx-auto max-w-4xl mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <RevealItem direction="left">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-secondary leading-relaxed">
              Les salles de spectacle et organisateurs d'événements gèrent leurs
              réservations avec des tableurs Excel ou des outils fragmentés.
              Aucune visibilité temps réel sur les ventes, pas de plan de salle
              interactif, gestion fiscale manuelle.
            </p>
          </motion.div>
        </RevealItem>
        ...
        <RevealItem direction="right">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-secondary leading-relaxed">
              Un dashboard unifié avec plan de salle 2D/3D, ventes en temps réel
              via WebSocket, gestion automatisée des tarifs et TVA.
        ...
        <RevealItem direction="right">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-secondary leading-relaxed">
              Dashboard livré en 1 mois. Latence WebSocket &lt; 200ms, 100% de
              couverture fiscale (TVA multi-taux), visualisation 3D performante,
              adoption immédiate par l'équipe opérations.
            </p>
          </motion.div>
        </RevealItem>
      </RevealContainer>
...
export function BilletterieScreenshots() {
        ...
        <RevealItem direction="scale">
          <MagneticWrapper strength={0.03}>
            <motion.div
              ...
              whileHover={{ scale: 1.05 }}
            >
              <LayoutDashboard className="w-4 h-4 text-accent-ink" />
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  dashboard.billetterie-interne.local/
...
export function BilletterieFeatures() {
  return (
    <section
      className="relative py-12 sm:py-16"
      ...
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        ...
        <RevealItem>
          <Paragraph
            ...
            className="mt-2 max-w-2xl mx-auto text-sm sm:text-base"
          >
            Dashboard temps réel, plan de salle 2D/3D, tarification multi-TVA et
            gestion complète des réservations et événements.
          </Paragraph>
        </RevealItem>
      </RevealContainer>
...
export function BilletterieArchitecture() {
  return (
    <section className="relative py-12 sm:py-16">
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        <RevealItem direction="scale">
        ...
        <RevealItem>
          <Paragraph
            ...
            className="mt-2 max-w-2xl mx-auto text-sm sm:text-base"
          >
            Une architecture Clean avec DDD et CQRS, pensée pour la performance
            temps réel et la scalabilité des réservations concurrentes.
          </Paragraph>
        </RevealItem>
      </RevealContainer>
...
export function BilletterieTechStack() {
  return (
    <section
      className="relative py-12 sm:py-16"
      style={{ background: `${BI.light}12` }}
...
export function BilletterieBottomCta() {
  return (
