...
export function CivitimeBackdrop() {
  return (
    <div
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <MagneticWrapper strength={0.04}>
                <motion.a
                  ...
                  whileHover={{
                    y: -2,
                    boxShadow: `0 12px 24px ${CT.purple}40`,
                  }}
...
export function CivitimeContext() {
  return (
      ...
      >
        ...
        <RevealItem direction="left">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-secondary leading-relaxed">
              ...
              organisations. 70% de taux de connexion moyen sur plusieurs mois,
              250 000+ collaborateurs mobilisés. Taux de complétion 65-73% vs
              10% pour le e-learning classique.
            </p>
          </motion.div>
        </RevealItem>
        ...
        <RevealItem direction="right">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-secondary leading-relaxed">
              Réécriture legacy en Clean Architecture DDD. Éditeur de scénarios.
              Dashboards et backoffice Directus. Outils marketing internes.
              Plateforme SaaS SCORM multi-tenant from scratch. Intégration SSO
              grands comptes. CI/CD et pipelines de déploiement continu.
            </p>
          </motion.div>
        </RevealItem>
      </RevealContainer>
...
export function CivitimeScreenshots() {
    ...
    >
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        ...
        <RevealItem>
          ...
          >
            City builders, quiz interactifs, escape games et univers immersifs.
            Des jeux déployés sur web et mobile pour sensibiliser à grande
            échelle.
          </Paragraph>
        </RevealItem>
      </RevealContainer>
...
export function CivitimeRoleEvolution() {
  return (
    <section className="relative py-12 sm:py-16">
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        <RevealItem direction="scale">
...
export function CivitimeFeatures() {
  return (
    <section
      className="relative py-12 sm:py-16"
      ...
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        ...
        <RevealItem>
          <Paragraph
            ...
            className="mt-2 max-w-2xl mx-auto text-sm sm:text-base"
          >
            Serious games, éditeur de contenu, gamification et plateforme SaaS.
            Des produits déployés à l'échelle pour des grands comptes
            internationaux.
          </Paragraph>
        </RevealItem>
      </RevealContainer>
...
export function CivitimeArchitecture() {
  return (
    <section className="relative py-12 sm:py-16">
      <RevealContainer className="container mx-auto text-center mb-8 sm:mb-10">
        <RevealItem direction="scale">
...
export function CivitimeTechStack() {
  return (
    <section
      className="relative py-12 sm:py-16"
      style={{ background: `${CT.warm}12` }}
...
export function CivitimeBottomCta() {
  return (
