...
const Testimonials = () => {
  return (
    ...
    >
      ...
      <RevealContainer staggerDelay={0.15} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
        {testimonials.map((testimonial, index) => (
          <RevealItem key={testimonial.name} direction={index % 2 === 0 ? "left" : "right"}>
            <motion.div
