...
const TrustedBy = () => {
  return (
    ...
    >
      ...
      <RevealContainer staggerDelay={0.15} className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto">
        {companies.map((company, index) => (
          <RevealItem key={company.name} direction="scale">
            <motion.div
              className="relative flex flex-col items-center justify-center gap-3 p-6 sm:p-8 rounded-2xl card-accent overflow-hidden"
              whileHover={{
                y: -12,
                scale: 1.02,
